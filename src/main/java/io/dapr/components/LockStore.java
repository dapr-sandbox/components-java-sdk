...
public interface LockStore extends InitializableWithProperties {
  ...
  boolean tryLock(@NonNull String requestLockOwner, @NonNull String requestResourceId, int requestExpiryInSeconds);

  UnlockStatus unlock(@NonNull String requestLockOwner, @NonNull String requestResourceId);
