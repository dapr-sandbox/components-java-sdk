...
public class InMemoryStateStore implements StateStore {
  ...
  private final Map<String, StateStore.Value> entries = new HashMap<>();
  ...
  @Override
  public Optional<StateStore.Value> get(@NonNull String key) {
  ...
  @Override
  public void set(@NonNull String key, @NonNull StateStore.Value value) {
